...
@Metadata(
        ...
        d2 = {"Lcom/example/signalussample1/fragment/secondSelectBottomBackFragment;", "Landroidx/fragment/app/Fragment;", "Landroid/view/View$OnClickListener;", "()V", "navController", "Landroidx/navigation/NavController;", "getNavController", "()Landroidx/navigation/NavController;", "setNavController", "(Landroidx/navigation/NavController;)V", "navigateWithValue", "", "index", "", "onClick", "v", "Landroid/view/View;", "onCreateView", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onViewCreated", "view", "app_debug"}
)
public final class secondSelectBottomBackFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_second_select_bottom_back, container, false);
    }
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ((ImageView)this._$_findCachedViewById(id.hip_shadow)).setOnClickListener((View.OnClickListener)this);
        ((ImageView)this._$_findCachedViewById(id.to_front_btn)).setOnClickListener((View.OnClickListener)this);
    }
    ...
    public void onClick(@Nullable View v) {
        ...
        if (var2 != null) {
            if (var2 == var3) {
                ...
                var10000.navigate(R.id.action_secondSelectBottomBackFragment_to_secondSelectBottomFragment);
                return;
            }
        }
    ...
    public final void navigateWithValue(@NotNull String index) {
        ...
        var10000.navigate(R.id.action_secondSelectBottomBackFragment_to_cameraFragment, bundle);
    }
