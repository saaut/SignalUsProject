...
@Metadata(
        ...
        d2 = {"Lcom/example/signalussample1_java/fragment/firstSelectFragment;", "Landroidx/fragment/app/Fragment;", "Landroid/view/View$OnClickListener;", "()V", "navController", "Landroidx/navigation/NavController;", "getNavController", "()Landroidx/navigation/NavController;", "setNavController", "(Landroidx/navigation/NavController;)V", "onClick", "", "v", "Landroid/view/View;", "onCreateView", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onViewCreated", "view", "app_debug"}
)
    ...
    public void onClick(@Nullable View v) {
        ...
        if (var2 != null) {
            if (var2 == var3) {
                ...
                var10000.navigate(R.id.action_firstSelectFragment_to_secondSelectFaceFragment);
                return;
            }
        }
        ...
        if (var2 != null) {
            if (var2 == var3) {
                ...
                var10000.navigate(R.id.action_firstSelectFragment_to_secondSelectTopFragment);
                return;
            }
        }
