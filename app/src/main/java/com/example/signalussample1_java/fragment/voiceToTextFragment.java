...
@Metadata(
        ...
        d2 = {"Lcom/example/signalussample1/fragment/voiceToTextFragment;", "Landroidx/fragment/app/Fragment;", "Landroid/view/View$OnClickListener;", "()V", "navController", "Landroidx/navigation/NavController;", "getNavController", "()Landroidx/navigation/NavController;", "setNavController", "(Landroidx/navigation/NavController;)V", "onClick", "", "v", "Landroid/view/View;", "onCreateView", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onViewCreated", "view", "app_debug"}
)
public final class voiceToTextFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView)this._$_findCachedViewById(id.again_txt)).setOnClickListener((View.OnClickListener)this);
    }
