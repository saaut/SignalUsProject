...
@Metadata(
        ...
        d2 = {"Lcom/example/signalussample1/fragment/secondSelectBottomFragment;", "Landroidx/fragment/app/Fragment;", "Landroid/view/View$OnClickListener;", "()V", "navController", "Landroidx/navigation/NavController;", "getNavController", "()Landroidx/navigation/NavController;", "setNavController", "(Landroidx/navigation/NavController;)V", "navigateWithValue", "", "index", "", "onClick", "v", "Landroid/view/View;", "onCreateView", "inflater", "Landroid/view/LayoutInflater;", "container", "Landroid/view/ViewGroup;", "savedInstanceState", "Landroid/os/Bundle;", "onViewCreated", "view", "app_debug"}
)
public final class secondSelectBottomFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ((ImageView)this._$_findCachedViewById(id.pelvic_left_shadow)).setOnClickListener((View.OnClickListener)this);
        ((ImageView)this._$_findCachedViewById(id.pelvic_right_shadow)).setOnClickListener((View.OnClickListener)this);
        ((ImageView)this._$_findCachedViewById(id.leg_left_shadow)).setOnClickListener((View.OnClickListener)this);
        ((ImageView)this._$_findCachedViewById(id.leg_right_shadow)).setOnClickListener((View.OnClickListener)this);
        ((ImageView)this._$_findCachedViewById(id.foot_left_shadow)).setOnClickListener((View.OnClickListener)this);
        ((ImageView)this._$_findCachedViewById(id.foot_right_shadow)).setOnClickListener((View.OnClickListener)this);
    }
    ...
    public void onClick(@Nullable View v) {
        ...
        if (var2 != null) {
            if (var2 == var3) {
                ...
                var10000.navigate(R.id.action_secondSelectBottomFragment_to_secondSelectBottomBackFragment);
                return;
            }
        }
    ...
    public final void navigateWithValue(@NotNull String index) {
        ...
        var10000.navigate(R.id.action_secondSelectBottomFragment_to_cameraFragment, bundle);
    }
